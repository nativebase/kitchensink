...
import { TypeaheadRenderItem, TypeaheadHook, TypeaheadBasic } from "../screens";
  ...
  return (
    <Stack.Navigator initialRouteName="toastUsage">
      ...
      <Stack.Screen
        ...
        options={{
          headerTitle: "Typeahead Render Item",
          headerLeft: () => {
            return <MenuButton toggleDrawer={props.navigation.toggleDrawer} />;
          },
          headerStyle: {
